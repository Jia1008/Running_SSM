...
public class Memberinfo implements java.io.Serializable {
	...
	public Memberinfo( Graderecord graderecord, String nickName,
			...
			Long point, String registerdate, String latestdate, Long status,
	...
	public String toString() {
		return "Memberinfo [id=" + id + ", graderecord=" + graderecord + ", nickName=" + nickName + ", passwd=" + passwd
				+ ", gender=" + gender + ", age=" + age + ", email=" + email + ", provinceCity=" + provinceCity
				+ ", address=" + address + ", phone=" + phone + ", passwdQuestion=" + passwdQuestion + ", passwdAnswer="
				+ passwdAnswer + ", recommender=" + recommender + ", point=" + point + ", registerdate=" + registerdate
				+ ", latestdate=" + latestdate + ", status=" + status + ", isonline=" + isonline + ", memberSpace="
				+ memberSpace + "]";
	}
