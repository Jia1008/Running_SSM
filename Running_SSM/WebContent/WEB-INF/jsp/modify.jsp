  			...
  			<tr>
				<td width="100%">
					...
					<tr>
						...
						<td width="30%" >
							<input type="text" maxLength="14" style="width:200px" name="nickName" disabled />
						</td>
						<th width="45%" >
					...
					<tr>
						...
						<td>
							<input type="text" maxLength="30" style="width:200px" name="email" />
						</td>
						<th>
					...
					<tr>
						...
						<th>
							<input style="width:200px" type="text" name="passwdQuestion" />
						</th>
						<th>
					...
					<tr>
						...
						<td>
							<input  type="text" style="width:200px" name="passwdAnswer" />
						</td>
						<th>
