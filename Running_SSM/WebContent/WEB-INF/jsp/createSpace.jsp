  			...
  			<tr>
				...
				<td width="100%">
					...
					<tr>
		  			...
		  			<form action="space/save" method="post"	enctype="multipart/form-data">
						...
						<tr>
							...
							<TD width="50%" align="left">
								<INPUT class=INPUT1 type=text maxLength=14 name=opinion style="width:200;height:25" />
							</TD>
						</tr>
						<TR>
							<TD width="50%" align="right">
						...
						<TR>
							...
							<TD width="50%" align="left">
								<INPUT class=INPUT1 type=text maxLength=14 name=cellphone style="width:200;height:25" />						
							</TD>
						</TR>
						<TR>
							<TD width="50%" align="right">
							...
							<TD width="50%" align="left">
								<INPUT class="INPUT1" type="text" maxLength="14" name="runplace" style="width:200;height:25" />						
							</TD>
						</TR>
						<TR>
