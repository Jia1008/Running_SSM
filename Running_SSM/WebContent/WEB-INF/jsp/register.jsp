     ...
     <div id="center">
       <div id="ltd">
	     ...
	     <TABLE cellSpacing=0 cellPadding=0 border=0>
	  			<TR>
    				<TD width="100%">
     					<FORM onSubmit="return validateRegisterForm(this);" action="member/register"  method="post">
     						<TABLE width="100%">
        						<thead>
        						<TR>
         							<TH colSpan=3>
								...
								<TBODY>
       							<TR>
         							...
         							<TH width="45%"><FONT color=#ff0000>昵称可使用长度为1-16的任何字符</FONT></TH>
								</TR>
								<TR>
									<TH>
								...
								<TR>
								  ...
								  <TD><INPUT onclick=javascript:changeText(); 
									type=checkbox name=re><input type="text" style="width:130px; display:none" value="0" id="retext" name="recommender" /></TD>
								  <TH><FONT color=#ff0000>如果有推荐人，请选择。并输入推荐人的会员ID</FONT> </TH></TR>
								
								<TR>
								  <TH>
									<DIV align=right>所在省份/城市： </DIV></TH>
								  <TD><SELECT name=provinceCity> <OPTION value=0 
								...
								<TR>
								  ...
								  <TH><IMG alt=authCode src="member/defineCode" id="changeCode" /> 
								  		<font></font>
								</TH></TR>
								<tfoot>
									<TR>
