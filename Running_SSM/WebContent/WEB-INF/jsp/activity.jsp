...
<link rel="stylesheet" type="text/css" id="css" href="tyle/style1.css" />
...
<div id="main">
  ...
  <div id="header">
    ...
    <div id="logo">
      <h1>跑步社区</h1></div>
	<div id="logout">
	<a href="member/loginout?name=${memberinfo_login.nickName }">注  销</a> | 收  藏
	 </div>
    <div id="mainnav">
      <ul>
      ...
      <span>
      		<table width="100%" border="0">
				<tr>
					<td align="right">
						上一次登录时间：中国标准时间 ${memberinfo_login.latestdate } 星期一
					</td>
					<td align="center">
						欢迎，&nbsp;
						<a href="isCreateSpace.action"><font color="red">
								[${memberinfo_login.nickName }]</font> </a>&nbsp;
					</td>
					<td align="left">
						当前您的积米：&nbsp;&nbsp;
						<font color="red">${memberinfo_login.point }</font>&nbsp;&nbsp;
						当前等级：
						<font color="red">${memberinfo_login.graderecord.gradename }</font>
					</td>
				</tr>
			</table> </span>    </div>
   </div>
...
到今天为止，盖茨和他的妻子Melinda Gates建立的基金已经将25多亿美元用于了全球的健康事业，将14亿多美元用于改善人们的学习条件，其中包括为盖茨图书馆购置计算机设备、为美国和加拿大的低收入社区的公共图书馆提供互联网培训和互联网访问服务             </p>
	 ...
	 <table width="300">
		...
		<tr>
			...
			<td align="left"><font color="green"><b>在线人数：${isonline_sum }</b></font></td>
		</tr>
