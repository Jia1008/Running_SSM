...
<div id="main">
  ...
  <div id="header">
    ...
    <div id="logo">
      <h1>跑步社区</h1></div>
	  <div id="logout">
	<a href="member/loginout?name=${space_inter.memberinfo.nickName }">注  销</a> | 收  藏
	 </div>
    <div id="mainnav">
      <ul>
						...
						<table width="100%">
							...
							<tr>
								<td rowspan="5" width="30%" class="line4">
									<img src="${space_inter.icon }" alt=Face width="84" height="84" ></td>
								<th width="25%" class="line1">
									昵称
								</th>
								<td width="45%">
									${space_inter.memberinfo.nickName }
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									${space_inter.memberinfo.graderecord.gradename }
								</td>
							</tr>
							<tr>
								<th class="line1">
								...
								<td>
									${space_inter.memberinfo.provinceCity }
								</td>
							</tr>
							<tr>
								<th class="line1">
							...
							<tr>
								<td colspan="3">
									...
									<input type="button" value="返回"
										onclick="location.href='activity.html' ;" style="width: 60;height: 25" />
								</td>
							</tr>
							</tfoot>
						</table>
