...
//	//用户名nickName
//	var $nickName=$("form font:eq(3)");
//	if($nickName.css("color")=='red'){
//		alert("该用户名已存在");
//		return false;
//	}
//	
//	var $passwd=$("form font:eq(5)");
//	if($passwd.css("color")=="red"){
//		alert("密码设置不合法");
//		return false;
//	}
//	
//	var $passwdre=$("form font:eq(7)");
//	if($passwdre.css("color")=="red"){
//		alert("两次密码输入不一致");
//		return false;
//	}
//	
//	var $email=$("form font:eq(9)");
//	if($email.css("color")=="red"){
//		alert("邮箱格式不正确");
//		return false;
//	}
//	
//	var $passwdQuestion=$("form font:eq(11)");
//	if($passwdQuestion.css("color")=="red"){
//		alert("输入字符小于6");
//		return false;
//	}
//	var $passwdAnswer=$("form font:eq(13)");
//	if($passwdAnswer.css("color")=="red"){
//		alert("提示字符小于6");
//		return false;
//	}
//	
//	var $age=$("form font:eq(17)");
//	if($age.css("color")=="red"){
//		alert("年龄必须是数字");
//		return false;
//	}
	if (isEmpty(nickName)) {
